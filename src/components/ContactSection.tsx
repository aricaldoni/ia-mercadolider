        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                <a href="https://wa.me/5491156195680" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-yellow-400 hover:text-yellow-300 transition-colors">
